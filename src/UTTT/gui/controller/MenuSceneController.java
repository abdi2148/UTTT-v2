...
import UTTT.gui.model.StatsModel;
import com.jfoenix.controls.*;
import UTTT.bll.bot.IBot;
import UTTT.bll.game.GameManager;
import UTTT.bll.game.stats.GameResult;
import UTTT.dal.DynamicBotClassHandler;
import static UTTT.gui.util.FontAwesomeHelper.getFontAwesomeIconFromPlayerId;
...
public class MenuSceneController implements Initializable {
    ...
    private void openStatsWindow() throws IOException {
        if(statsWindow==null)
        {
            ...
            FXMLLoader fxLoader = new FXMLLoader(
                    getClass().getResource("/UTTT/gui/view/StatsScene.fxml"));

            Parent root = fxLoader.load();

            StatsSceneController controller
                    = ((StatsSceneController) fxLoader.getController());
    ...
    public void clickStart(ActionEvent actionEvent) throws IOException {
        if (simulation.get()) {
            ...
            FXMLLoader fxLoader = new FXMLLoader(getClass().getResource("/UTTT/gui/view/GameScene.fxml"));

            Parent root = fxLoader.load();

            GameSceneController controller = ((GameSceneController) fxLoader.getController());
